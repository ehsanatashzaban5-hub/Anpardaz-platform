...
export function registerAiRoutes(app:FastifyInstance,pool:Pool){const gateway=new AiGateway(pool);
 app.get('/api/v1/ai/models',{preHandler:requireAuth},async(req,reply)=>{
  ...
  const catalog:any[]=[
    ...
    {id:'gemini-3.1-pro-preview',name:'Gemini 3.1 Pro',providerId:'gemini',provider:'Google',descFa:'استدلال پیشرفته برای حل مسئله و عامل‌ها',capabilities:['reasoning','vision','coding'],contextWindow:'1M',badge:'pro',isAvailable:true},
    {id:'gemini-3.6-flash',name:'Gemini 3.6 Flash',providerId:'gemini',provider:'Google',descFa:'مدل پایدار چندرسانه‌ای برای کارهای عمومی و عامل‌ها',capabilities:['fast','vision','coding','reasoning'],contextWindow:'1M',isAvailable:true},
    {id:'gemini-3.5-flash',name:'Gemini 3.5 Flash',providerId:'gemini',provider:'Google',descFa:'مدل سریع برای پردازش پرتعداد',capabilities:['fast','vision','writing'],contextWindow:'1M',isAvailable:true},
    {id:'gemini-3.1-flash-lite',name:'Gemini 3.1 Flash-Lite',providerId:'gemini',provider:'Google',descFa:'مدل کم‌هزینه برای پردازش پرتعداد',capabilities:['fast','writing','translation'],contextWindow:'1M',isAvailable:true},
    ...
    {id:'claude-fable-5',name:'Claude Fable 5',providerId:'anthropic',provider:'Anthropic',descFa:'مدل پیشرفته برای استدلال عمیق و عامل‌های طولانی',capabilities:['reasoning','coding','writing','vision'],contextWindow:'1M',badge:'pro',isAvailable:true},
    {id:'claude-opus-4-8',name:'Claude Opus 4.8',providerId:'anthropic',provider:'Anthropic',descFa:'استدلال عمیق برای تحلیل و کدنویسی پیچیده',capabilities:['reasoning','coding','writing','vision'],contextWindow:'1M',badge:'pro',isAvailable:true},
    {id:'claude-sonnet-4-6',name:'Claude Sonnet 4.6',providerId:'anthropic',provider:'Anthropic',descFa:'تعادل سرعت و هوش برای کارهای تولیدی',capabilities:['reasoning','coding','writing','vision'],contextWindow:'1M',isAvailable:true},
